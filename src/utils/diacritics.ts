...
export const remove = removeDiacritics;

const replacementList: { chars: string; base: string }[] = [
  {
    base: ' ',
    chars: '\u00A0',
  },
...
const baseCharsSet = new Set<string>();
const diacriticsMap: { [key: string]: string } = {};

for (const { base, chars } of replacementList) {
  baseCharsSet.add(base);
...
const _replacementList = replacementList;
export { _replacementList as replacementList };
const _diacriticsMap = diacriticsMap;
export { _diacriticsMap as diacriticsMap };
