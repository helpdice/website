...
//         </div>
//         <button type="submit"
//           className="bg-gray-300 hover:bg-gray-400 text-sm text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
//           Post comment
//         </button>
//       </form>
...
//           </div>
//         </footer>
//         <p className="pt-0">Very straight-to-point article. Really worth time reading. Thank you! But tools are just the
