          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <Link href="https://www.facebook.com/people/Helpdice/100090491326455/" aria-label="social icon">
                    <svg
                ...
                <li>
                  <Link href="https://www.linkedin.com/company/helpdice" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
                ...
                <li>
                  <Link href="https://www.instagram.com/helpdice/" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
